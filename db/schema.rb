...
ActiveRecord::Schema[7.1].define(version: 2023_12_03_021031) do
  create_table "event_attendings", force: :cascade do |t|
    ...
    t.index ["creator_id"], name: "index_event_attendings_on_creator_id"
  ...
  add_foreign_key "event_attendings", "users", column: "creator_id"
